...
func CreateCourse(c *gin.Context) {
	...
	*/
	...
	// for i := range course.Detail {
	// 	course.Detail[i].ID = bson.NewObjectId()
	// }
	common.CheckError(c, err)
...
func UpdateCourse(c *gin.Context) {
	...
	fmt.Println("------------", course.Detail)

	// err = database.C(models.CollectionCourse).UpdateId(course.ID, course)
	err = database.C(models.CollectionCourse).UpdateId(course.ID, bson.M{"$set": bson.M{"Detail": course.Detail}})
	common.CheckError(c, err)
